...
/**
  * 此程序：spark SQL 查询完HBase ，构建成符合格式的RDD(json)
  * 调用这个程序存入
  * Created by cluster on 2017/3/1.
  */
object toMongoTest extends Serializable{

  // *****获取Mongo的连接*****
  //通过连接认证获取MongoDB连接
  //  val mongoClient: MongoClient  = new MongoClient("192.168.39.96", 27017)
  val mongoClient: MongoClient  = new MongoClient("192.168.31.7", 27017)
  //连接到 数据库
  ...
  //获取集合 参数为“集合名称”
  val mongoCollection: MongoCollection[Document]  = mongoDatabase.getCollection("sku_0317_test")
  ...
  def updateExistSKU(jsonSku: JSONObject): Unit ={
    ...
    val mocseentime_long: Date = new Date(formatlasttime.format(new Date(moc.getString("lastseentime"))))
    val mocseentime_short = format.format(new Date(moc.getString("lastseentime")))

    val jsonSkutime_long: Date = new Date(formatlasttime.format(new Date(jsonSku.getString("lastseentime"))))
    val jsonSkutime_short = format.format(new Date(jsonSku.getString("lastseentime")))
    //根据时间来判断  时间是否更新
    if ((mocseentime_short != jsonSkutime_short) || (mocseentime_short == jsonSkutime_short && jsonSkutime_long.getTime > mocseentime_long.getTime)){
      val seentime: String = format.format(new Date(jsonSku.getString("shelvetime")))
...
//      }
      if (jsonSkutime_long.getTime > mocseentime_long.getTime){
        mongoCollection.updateOne(Filters.eq("_id", moc.get("_id")),new Document("$set", new Document("storeup", jsonSku.getInt("storeup"))))
      }
      ...
      if (jsonSku.get("discountprice").isInstanceOf[Double]) {
        ...
        if(!doc_moc.containsKey(seentime)){
          ...
          doc_update = doc_moc.append(seentime,jsonSku.getDouble("discountprice"))
          mongoCollection.updateOne(Filters.eq("_id", moc.get("_id")),new Document("$set", new Document("discountlist", doc_update)))
        }
        ...
        if(!doc_moc.containsKey(seentime)){
          ...
          doc_update = doc_moc.append(seentime,jsonSku.getInt("discountprice"))
          mongoCollection.updateOne(Filters.eq("_id", moc.get("_id")),new Document("$set", new Document("discountlist", doc_update)))
        }
      }
      ...
      //*** 更新 lastseentime
      if (jsonSku.getString("lastseentime") != "" && jsonSkutime_long.getTime > mocseentime_long.getTime){
  ...
  def main(args: Array[String]) {
        val jsonstr = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":211531,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027170\",\"discountprice\":211531,\"shelvetime\":\"2017/02/24 21:15:31\",\"stock\":211531,\"storeup\":211531,\"sales\":211531,\"lastseentime\":\"2017/02/24 21:15:31\"}"
        val json = new JSONObject(jsonstr)
        toMongo(json)
    //
    //
        val jsonstr1 = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":212031,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027170\",\"discountprice\":212031,\"shelvetime\":\"2017/02/24 21:20:31\",\"stock\":212031,\"storeup\":212031,\"sales\":212031,\"lastseentime\":\"2017/02/24 21:20:31\"}"
        val json1 = new JSONObject(jsonstr1)
        toMongo(json1)
    //
    //
        val jsonstr2 = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":1445,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027170\",\"discountprice\":1,\"shelvetime\":\"2017/03/01 21:15:31\",\"stock\":1,\"storeup\":1,\"sales\":1,\"lastseentime\":\"2017/03/01 21:15:31\"}"
        val json2 = new JSONObject(jsonstr2)
        toMongo(json2)
    //
    //
        val jsonstr3 = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":1445,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027170\",\"discountprice\":2,\"shelvetime\":\"2017/03/01 21:10:31\",\"stock\":2,\"storeup\":2,\"sales\":2,\"lastseentime\":\"2017/03/01 21:10:31\"}"
        val json3 = new JSONObject(jsonstr3)
        toMongo(json3)
    //
        val jsonstr4 = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":1445,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027170\",\"discountprice\":202031,\"shelvetime\":\"2017/02/24 20:20:31\",\"stock\":202031,\"storeup\":202031,\"sales\":202031,\"lastseentime\":\"2017/02/24 20:20:31\"}"

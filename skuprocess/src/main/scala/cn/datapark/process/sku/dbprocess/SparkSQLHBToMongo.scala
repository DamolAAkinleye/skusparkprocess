...
/**
  ...
  */
object SparkSQLHBToMongo extends Serializable{
...
//  val mongoDatabase: MongoDatabase  = mongoClient.getDatabase("test")
  ...
  //获取集合 参数为“集合名称”
  val mongoCollection: MongoCollection[Document]  = mongoDatabase.getCollection("sku_info_0322_2")
  //创建索引
  mongoCollection.createIndex()
//  val mongoCollection: MongoCollection[Document]  = mongoDatabase.getCollection("sku_test")
  ...
  def toMongo(jsonSku: JSONObject): Unit ={
    ...
    if (isSKUExist(jsonSku.getString("sku_id"))){// ***添加判断sku是否存在
      ...
      doc.append("category_indextype",jsonSku.getString("category_indextype"))
      doc.append("category_description",jsonSku.getString("category_description"))
      doc.append("category_style",jsonSku.getString("category_style"))
      doc.append("material_alias",jsonSku.getString("material_alias"))
      doc.append("print_alias",jsonSku.getString("print_alias"))
      doc.append("collarmodel",jsonSku.getString("collarmodel"))
      //添加默认字段、赋予默认值style_alias，model_alias，sleevemodel_alias
      doc.append("style_alias","暂无")
      doc.append("model_alias","暂无")
      doc.append("sleevemodel_alias","暂无")
      doc.append("src_name",jsonSku.getString("src_name"))
      doc.append("brand_alias",jsonSku.getString("brand_alias"))
...
//    val doc_other: Document = new Document() //创建文档对象
  ...
  def main(args: Array[String]) {
    val jsonstr = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":1445,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027170\",\"discountprice\":99,\"shelvetime\":\"2017/02/24 21:15:31\",\"stock\":330,\"storeup\":988,\"sales\":1,\"lastseentime\":\"2017/02/24 21:15:31\",\"category_indextype\":\"women\",\"category_description\":\"milk\",\"category_style\":\"beautiful\",\"material_alias\":\"mama\",\"print_alias\":\"flower\",\"collarmodel\":\"\"}"
    val json = new JSONObject(jsonstr)
    toMongo(json)
//
//
    val jsonstr1 = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":1445,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027171\",\"discountprice\":99,\"shelvetime\":\"2017/02/24 21:15:31\",\"stock\":330,\"storeup\":988,\"sales\":1,\"lastseentime\":\"2017/02/24 21:15:31\",\"category_indextype\":\"women\",\"category_description\":\"milk\",\"category_style\":\"beautiful\",\"material_alias\":\"mama\",\"print_alias\":\"flower\",\"collarmodel\": null}"
    val json1 = new JSONObject(jsonstr1)
    toMongo(json1)
//
//
    val jsonstr2 = "{\"brand_productid\":\" V5937\",\"color_alias\":\"[\\\"绿\\\"]\",\"commentcount\":1445,\"otherinfo\":\"{\\\"厚薄\\\":\\\" 常规\\\",\\\"基础风格\\\":\\\" 时尚都市\\\",\\\"适用场景\\\":\\\" 日常\\\",\\\"面料分类\\\":\\\" 其他\\\",\\\"袖型\\\":\\\" 常规\\\",\\\"销售渠道类型\\\":\\\" 纯电商(只在线上销售)\\\",\\\"适用对象\\\":\\\" 中年\\\",\\\"袖长\\\":\\\" 短袖\\\",\\\"细分风格\\\":\\\" 商务休闲\\\",\\\"款式细节\\\":\\\" 其他\\\",\\\"印花主题\\\":\\\" 几何图案\\\",\\\"服饰工艺\\\":\\\" 水洗\\\"}\",\"item_id\":\"44108251507\",\"sku_id\":\"3188188027172\",\"discountprice\":99,\"shelvetime\":\"2017/02/24 21:15:31\",\"stock\":330,\"storeup\":988,\"sales\":1,\"lastseentime\":\"2017/02/24 21:15:31\",\"category_indextype\":\"women\",\"category_description\":\"milk\",\"category_style\":\"beautiful\",\"material_alias\":\"mama\",\"print_alias\":\"flower\",\"collarmodel\":\"dsds\"}"
